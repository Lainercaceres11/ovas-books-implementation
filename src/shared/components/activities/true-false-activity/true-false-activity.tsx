...
import type { InitialState, OptionRadio } from './types/types';
...
export const TrueFalseActivity: React.FC<Props> & SubComponents = ({ children, onResult, minSelected = 1, addClass }: Props) => {
...
TrueFalseActivity.Option = Option;
